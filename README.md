...
![VSCode](https://img.shields.io/badge/VSCode-0078d7?style=flat&logo=visualstudiocode&logoColor=white)
...
| 프로젝트명 | 설명 | 기술스택 | 링크 |
|-------------|------|-----------|------|
| 🛍️ **Mall API** | Spring Boot 기반 쇼핑몰 백엔드 | Java, Spring Boot, Oracle | [🔗 바로가기](https://github.com/yspace/mallapi) |
...
### 🌱 현재 배우는 중이에요
<!-- - **Spring Framework 고급 기능 (DI, AOP, MVC 구조 이해)**   -->
- **AWS 클라우드 서비스 구축 및 배포 자동화**  
- **RPA + ChatGPT 통합 자동화 솔루션 구현**

---

### 📫 연락하기
📧 Email: `EMAIL@gmail.com`  
💼 Blog: [https://BLOG.dev](https://BLOG.dev)  
📍 GitHub: [https://github.com/yspaceS2](https://github.com/yspaceS2)

---

> 🧠 “기술은 사람을 돕기 위한 도구다.”  
> 늘 새로운 기술을 배우며, 더 나은 사용자 경험을 만드는 개발자가 되고 싶습니다. 🌿
